...
void enviar_texto_app(String mensaje, int contador) {
  ...
  // hayAlgo = false;
  // recibidos[3];
  // Serial.println("EN APP APARECE DESPUES DE FALLIDOS");
  // while (true) {
  //     while (Serial1.available()) {
  //         Serial1.readBytes(recibidos, 2);
  //         hayAlgo = true;
  ...
  // }
  // delay(2000);
  // Serial.println("EN APP APARECE INTENTOS");
  // limpiarBuffer();
  // Serial1.println("Mostrar ,#Incidentes: " + String(cantidad_de_incidentes));
  // hayAlgo = false;
  // recibidos[3];
  ...
  // }
  // delay(2000);
  // Serial.println("EN APP APARECE INCIDENTES");
  // limpiarBuffer();
  // Serial1.println("Mostrar ,#Usuarios activos: " + String(usuarios_activos));
  // hayAlgo = false;
  // recibidos[3];
  ...
  // }
  // delay(2000);
  // Serial.println("EN APP APARECE USUARIOS");
  // limpiarBuffer();
}
...
void ingreso_celular() {
  ...
  menu_seleccionar_teclado(menu_actual);
  //----- panel u blutoh
  if(KEYPAD_ACTIVO && !APLICACION_ACTIVA) {
    lcd.clear();  // Borra la pantalla LCD.
    lcd.setCursor(0, 1);
